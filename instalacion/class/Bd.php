...
class Bd {
    ...
    private function __construct($bd_host, $bd_user, $bd_pass, $bd_name) {
        $this->_error = array(
            '2002' => 'No se pudo conectar con el servidor MySQL',
            '2005' => 'No se pudo conectar con el servidor MySQL',
            '1045' => 'Acceso denegado,  usuario o contraseña incorrecto',
    ...
    private function _prepare($sql, $parametros) {
        ...
        $sql = preg_replace_callback("/(\?)/i", array($this, "_reemplazar"), $sql);
        $this->_sql = $sql;
        return $sql;
    }
